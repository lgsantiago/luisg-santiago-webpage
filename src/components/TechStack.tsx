...
const TechStack: React.FC = () => {
      ...
      technologies: [
        {
          ...
          icon: "⚛️",
          description:
            "Expert in building scalable React applications with modern patterns",
          yearsOfExperience: 5,
        },
        {
          name: "TypeScript",
        ...
        },
        {
          ...
          icon: "🟨",
          description:
            "Modern JavaScript with deep understanding of the language",
          yearsOfExperience: 8,
        },
        {
          name: "HTML5 & CSS3",
    ...
    },
    {
      ...
      technologies: [
        ...
        },
        {
          ...
          icon: "🔥",
          description:
            "Google's platform for building mobile and web applications",
          yearsOfExperience: 3,
        },
      ],
    },
  ...
  const activeCategoryData = techCategories.find(
      ...
      <div className="container">
        ...
        <div className="technologies-container">
          {isLoading ? (
            <div className="technologies-grid">
              {[...Array(4)].map((_, i) => (
                <SkeletonLoader key={i} variant="tech-card" />
              ))}
            </div>
          ) : activeCategoryData ? (
            <div className="technologies-grid">
        ...
        <div className="tech-summary">
          ...
          <div className="summary-text">
            <p>
              I'm passionate about learning new technologies and staying current
              with industry trends. My diverse skill set allows me to work
              across the full stack, from database design to user interface
              implementation.
            </p>
